...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="resume-header__photo glow">
        <Image
      ...
      <div className="resume-header__content">
        <h1 className="resume-header__name accent-gradient" itemProp="name">
          Grażyna Dachtera
        </h1>
        ...
        <p className="resume-header__role">
          ...
          <span className="badge badge--sub">Shipped 10+ features</span>
        </p>

        <p className="resume-header__availability" aria-label="Availability">
        ...
        <div className="resume-header__cta">
          <a
        ...
        <ul className="resume-header__contacts" aria-label="Contact links">
          {CONTACTS.map(({ type, label, href, copy: copyText }) => (
            <li key={href} className="resume-header__contact">
              <Icon type={type} />
              <a
                href={href}
                target={href.startsWith("http") ? "_blank" : undefined}
                rel={
                  href.startsWith("http") ? "me noreferrer noopener" : undefined
                }
                itemProp={
                  type === "email"
                    ? "email"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            email: "mailto:grazynadachtera@gmail.com",
